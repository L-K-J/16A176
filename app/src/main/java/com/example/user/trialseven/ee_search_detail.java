...
public class ee_search_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ee_search_detail);
    ...
    private void getJobInfo(){
        ...
        class GetJobInfo extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ee_search_detail.this,"Loading...","Please Wait...",false,false);
            }
